#!/usr/bin/env bash
# Post-build smoke checks for debug Tier A output.
set -euo pipefail
...
for member in package/package.json package/src/index.js package/src/node.js; do
...
node --check "${tmpdir}/package/src/node.js"
