#!/usr/bin/env bash
# Tier A factory build: ws from git source via npm pack (local checkout only).
...
expected_sha="c791e707eab3c13dd9a261d2479c3cc4a49a6fed"
...
assert_tgz_has_member "${main_tgz}" package/lib/websocket.js
