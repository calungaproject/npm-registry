#!/usr/bin/env bash
# Tier A factory build: chalk from git source via npm pack (local checkout only).
...
SRC="${WORK_DIR}/chalk-src"
rm -rf "${SRC}"
mkdir -p "${OUT_DIR}" "$(dirname "${main_tgz}")"

EXPECTED_SHA="661317e6f91fe7c90306c2c48ea9354562ee9146"
